...
export interface PenaltyDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  /**
   * Find zero or more Penalties that matches the filter.
   * @param {PenaltyFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const penalty = await prisma.penalty.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  findRaw(args?: Prisma.PenaltyFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>

  /**
   * Perform aggregation operations on a Penalty.
   * @param {PenaltyAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const penalty = await prisma.penalty.aggregateRaw({
   *   pipeline: [
   ...
   * })
   */
  aggregateRaw(args?: Prisma.PenaltyAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>
 ...
 * Penalty findRaw
 */
export type PenaltyFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
...
/**
 * Penalty aggregateRaw
 */
export type PenaltyAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
