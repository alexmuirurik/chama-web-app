...
export interface SavingDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  /**
   * Find zero or more Savings that matches the filter.
   * @param {SavingFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const saving = await prisma.saving.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  findRaw(args?: Prisma.SavingFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>

  /**
   * Perform aggregation operations on a Saving.
   * @param {SavingAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const saving = await prisma.saving.aggregateRaw({
   *   pipeline: [
   ...
   * })
   */
  aggregateRaw(args?: Prisma.SavingAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>
 ...
 * Saving findRaw
 */
export type SavingFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
 ...
 * Saving aggregateRaw
 */
export type SavingAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
